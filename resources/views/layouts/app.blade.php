    ...
    <header class="bg-white shadow-sm relative z-50">
        ...
        <div class="absolute top-0 left-0 w-full h-36 z-0 pointer-events-none overflow-hidden">
            <svg class="w-full h-full opacity-90" preserveAspectRatio="none" viewBox="0 0 1000 144">
                <!-- Top Line (Blue) -->
                <!-- Slanting up higher so it stays completely clear of the Search Bar -->
                <path d="M -10 112 L 260 112 L 340 20 L 1010 20" fill="none" stroke="#0a84d4" stroke-width="4" stroke-linejoin="round" />
                <!-- Bottom Line (Yellow) -->
                <path d="M -10 120 L 260 120 L 340 28 L 1010 28" fill="none" stroke="#ffb900" stroke-width="4" stroke-linejoin="round" />
            </svg>
        </div>
