...
<body class="antialiased min-h-screen flex flex-col">
    ...
    <header class="bg-white shadow-sm relative z-50">
        ...
        <div class="absolute top-0 left-0 w-full h-36 z-0 pointer-events-none overflow-hidden">
            <svg class="w-full h-full opacity-90" preserveAspectRatio="none" viewBox="0 0 1000 144">
                ...
                <path d="M -10 102 L 260 102 L 320 45 L 1010 45" fill="none" stroke="#007DCC" stroke-width="10"
                    stroke-linejoin="round" />

                <path d="M -10 118 L 260 118 L 320 61 L 1010 61" fill="none" stroke="#FFB900" stroke-width="10"
                    stroke-linejoin="round" />
            </svg>
        </div>
        ...
        <div class="container mx-auto px-4 h-36 relative z-10 flex items-center">
            ...
            <div class="flex-1 h-full flex flex-col justify-between">
                ...
                <div class="h-24 flex items-center justify-end pl-12 lg:pl-24">
                    ...
                    <div
                        class="w-full max-w-2xl flex items-center h-12 rounded-lg overflow-hidden shadow-sm border border-gray-200 bg-white">
                        <select
                            class="h-full bg-gray-50 text-gray-700 px-4 text-sm outline-none hover:bg-gray-100 cursor-pointer hidden md:block border-none font-medium">
                            <option>Semua Kategori</option>
                            <option>Seragam</option>
                            <option>Alat Tulis</option>
                        </select>
                        <input type="text" placeholder="Cari kebutuhan sekolah..."
                            class="h-full w-full px-5 text-black outline-none text-sm border-l border-gray-200">
                        <button
                            class="bg-accent hover:bg-accent-hover h-full px-8 text-gray-900 transition flex items-center justify-center">
                    ...
                    <div class="flex items-center gap-6 ml-8 shrink-0 text-gray-700">
                        ...
                        <a href="#" class="flex items-center gap-2 hover:text-primary transition group">
                            <div class="relative">
                                <span
                                    class="absolute -top-1.5 -right-2 bg-accent text-gray-900 text-xs font-bold px-1.5 py-0.5 rounded-full shadow-sm z-10">0</span>
                                <i class="ph ph-shopping-cart text-3xl text-gray-700 group-hover:text-primary"></i>
                            </div>
                            <span
                                class="font-bold text-sm hidden md:block text-gray-800 group-hover:text-primary ml-1">Keranjang</span>
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-primary-dark text-white text-sm relative z-20">
            <div
                class="container mx-auto px-4 py-2 flex items-center gap-2 overflow-x-auto whitespace-nowrap hide-scrollbar">
    ...
    <main class="flex-1 relative bg-gray-50">
        ...
        <div class="relative w-full overflow-hidden bg-white" id="main-carousel">
            <div class="flex overflow-x-auto snap-x snap-mandatory hide-scrollbar scroll-smooth" id="carousel-track">
                <div class="w-full shrink-0 snap-center relative">
                    <img src="{{ asset('images/banner_seragam_1786530000359.png') }}" alt="Promo Seragam Sekolah"
                        class="w-full h-[300px] md:h-[450px] object-cover object-center">
                    <div
                        ...
                        <div class="container mx-auto px-6 pb-12 md:pb-16 text-white">
                            <span
                                class="bg-accent text-gray-900 font-bold px-3 py-1 rounded-full text-xs uppercase tracking-wide mb-3 inline-block">Special
                                Promo</span>
                            <h2 class="text-3xl md:text-5xl font-extrabold mb-2 text-shadow">Promo Seragam Sekolah</h2>
                            <p class="text-sm md:text-lg font-medium text-gray-100 max-w-xl text-shadow-sm">Beli seragam
                                baru dengan kualitas terbaik harga terjangkau untuk tahun ajaran baru.</p>
                            <button
                                class="mt-4 bg-primary text-white font-bold px-6 py-2.5 rounded shadow hover:bg-primary-dark transition">Belanja
                                Sekarang</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="w-full shrink-0 snap-center relative">
                    <img src="{{ asset('images/banner_buku_1786530030265.png') }}" alt="Diskon Buku Tulis"
                        class="w-full h-[300px] md:h-[450px] object-cover object-center">
                    <div
                        class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent flex flex-col justify-end">
                        <div class="container mx-auto px-6 pb-12 md:pb-16 text-white">
                            <span
                                class="bg-accent text-gray-900 font-bold px-3 py-1 rounded-full text-xs uppercase tracking-wide mb-3 inline-block">Diskon
                                Terbesar</span>
                            <h2 class="text-3xl md:text-5xl font-extrabold mb-2 text-shadow">Gudang Alat Tulis</h2>
                            <p class="text-sm md:text-lg font-medium text-gray-100 max-w-xl text-shadow-sm">Lengkapi
                                kebutuhan alat tulis dan buku pelajaran kamu di sini.</p>
                            <button
                                class="mt-4 bg-primary text-white font-bold px-6 py-2.5 rounded shadow hover:bg-primary-dark transition">Belanja
                                Sekarang</button>
                        </div>
                ...
                <div class="w-full shrink-0 snap-center relative">
                    <img src="{{ asset('images/banner_pramuka_1786530042974.png') }}" alt="Atribut Pramuka Lengkap"
                        class="w-full h-[300px] md:h-[450px] object-cover object-center">
                    <div
                        class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent flex flex-col justify-end">
                        <div class="container mx-auto px-6 pb-12 md:pb-16 text-white">
                            <span
                                class="bg-accent text-gray-900 font-bold px-3 py-1 rounded-full text-xs uppercase tracking-wide mb-3 inline-block">Pramuka
                                Lengkap</span>
                            <h2 class="text-3xl md:text-5xl font-extrabold mb-2 text-shadow">Koleksi Atribut Pramuka
                            </h2>
                            <p class="text-sm md:text-lg font-medium text-gray-100 max-w-xl text-shadow-sm">Dari topi
                                hingga sabuk, temukan semua atribut pramuka dengan mudah.</p>
                            <button
                                class="mt-4 bg-primary text-white font-bold px-6 py-2.5 rounded shadow hover:bg-primary-dark transition">Belanja
                                Sekarang</button>
                        </div>
                ...
                <!-- Slide 4: Tas & Sepatu -->
                <div class="w-full shrink-0 snap-center relative">
                    <img src="{{ asset('images/banner_tas_1786530062086.png') }}" alt="Tas & Sepatu Sekolah"
                        class="w-full h-[300px] md:h-[450px] object-cover object-center">
                    <div
                        class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent flex flex-col justify-end">
                        <div class="container mx-auto px-6 pb-12 md:pb-16 text-white">
                            <span
                                class="bg-accent text-gray-900 font-bold px-3 py-1 rounded-full text-xs uppercase tracking-wide mb-3 inline-block">Koleksi
                                Baru</span>
                            <h2 class="text-3xl md:text-5xl font-extrabold mb-2 text-shadow">Tas & Sepatu Sekolah</h2>
                            <p class="text-sm md:text-lg font-medium text-gray-100 max-w-xl text-shadow-sm">Tampil lebih
                                gaya di sekolah dengan koleksi sepatu dan tas terbaru kami.</p>
                            <button
                                class="mt-4 bg-primary text-white font-bold px-6 py-2.5 rounded shadow hover:bg-primary-dark transition">Belanja
                                Sekarang</button>
                        </div>
                ...
                <!-- Slide 5: Flash Sale -->
                <div class="w-full shrink-0 snap-center relative">
                    <img src="{{ asset('images/banner_flashsale_1786530082778.png') }}"
                        alt="Flash Sale Kebutuhan Sekolah"
                        class="w-full h-[300px] md:h-[450px] object-cover object-center">
                    <div
                        class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent flex flex-col justify-end">
                        <div class="container mx-auto px-6 pb-12 md:pb-16 text-white">
                            <span
                                class="bg-red-500 text-white font-bold px-3 py-1 rounded-full text-xs uppercase tracking-wide mb-3 inline-block">Waktu
                                Terbatas</span>
                            <h2 class="text-3xl md:text-5xl font-extrabold mb-2 text-shadow">Flash Sale Up to 50%</h2>
                            <p class="text-sm md:text-lg font-medium text-gray-100 max-w-xl text-shadow-sm">Jangan
                                lewatkan diskon besar-besaran untuk kebutuhan sekolah hari ini!</p>
                            <button
                                class="mt-4 bg-primary text-white font-bold px-6 py-2.5 rounded shadow hover:bg-primary-dark transition">Belanja
                                Sekarang</button>
                        </div>
            ...
            <div class="absolute bottom-6 left-1/2 -translate-x-1/2 flex items-center gap-2" id="carousel-indicators">
                <button class="w-2.5 h-2.5 md:w-3 md:h-3 rounded-full bg-white transition indicator-dot"
                    data-index="0"></button>
                <button
                    class="w-2.5 h-2.5 md:w-3 md:h-3 rounded-full bg-white/50 hover:bg-white transition indicator-dot"
                    data-index="1"></button>
                <button
                    class="w-2.5 h-2.5 md:w-3 md:h-3 rounded-full bg-white/50 hover:bg-white transition indicator-dot"
                    data-index="2"></button>
        ...
        <div class="container mx-auto px-4 relative z-10 pt-6">
            <div class="bg-white rounded-sm shadow-sm border border-gray-200">
                ...
                <div class="grid grid-cols-4 md:grid-cols-6 lg:grid-cols-8 border-l border-t border-gray-100">
                    ...
                    <a href="#"
                        class="flex flex-col items-center justify-center p-4 border-r border-b border-gray-100 bg-white hover:shadow-lg transition relative hover:-translate-y-0.5 hover:z-10 group">
                        <i
                            class="ph-fill ph-t-shirt text-4xl text-gray-600 group-hover:text-primary mb-2 transition"></i>
                        <span class="text-[12px] md:text-[13px] text-gray-700 text-center leading-tight">Seragam
                            SD</span>
                    </a>
                    <a href="#"
                        class="flex flex-col items-center justify-center p-4 border-r border-b border-gray-100 bg-white hover:shadow-lg transition relative hover:-translate-y-0.5 hover:z-10 group">
                    ...
                    <a href="#"
                        class="flex flex-col items-center justify-center p-4 border-r border-b border-gray-100 bg-white hover:shadow-lg transition relative hover:-translate-y-0.5 hover:z-10 group">
                        <i
                            class="ph-fill ph-sneaker text-4xl text-gray-600 group-hover:text-primary mb-2 transition"></i>
                        <span class="text-[12px] md:text-[13px] text-gray-700 text-center leading-tight">Sepatu
                            Sekolah</span>
                    </a>
                    ...
                    <a href="#"
                        class="flex flex-col items-center justify-center p-4 border-r border-b border-gray-100 bg-white hover:shadow-lg transition relative hover:-translate-y-0.5 hover:z-10 group">
                        <i
                            class="ph-fill ph-backpack text-4xl text-gray-600 group-hover:text-primary mb-2 transition"></i>
                        <span class="text-[12px] md:text-[13px] text-gray-700 text-center leading-tight">Tas
                            Sekolah</span>
                    </a>
                    ...
                    <a href="#"
                        class="flex flex-col items-center justify-center p-4 border-r border-b border-gray-100 bg-white hover:shadow-lg transition relative hover:-translate-y-0.5 hover:z-10 group">
                        <i
                            class="ph-fill ph-notebook text-4xl text-gray-600 group-hover:text-primary mb-2 transition"></i>
                        <span class="text-[12px] md:text-[13px] text-gray-700 text-center leading-tight">Buku
                            Tulis</span>
                    </a>
                    ...
                    <a href="#"
                        class="flex flex-col items-center justify-center p-4 border-r border-b border-gray-100 bg-white hover:shadow-lg transition relative hover:-translate-y-0.5 hover:z-10 group">
                        <i
                            class="ph-fill ph-pen-nib text-4xl text-gray-600 group-hover:text-primary mb-2 transition"></i>
                        <span class="text-[12px] md:text-[13px] text-gray-700 text-center leading-tight">Alat
                            Tulis</span>
                    </a>
                    ...
                    <a href="#"
                        class="flex flex-col items-center justify-center p-4 border-r border-b border-gray-100 bg-white hover:shadow-lg transition relative hover:-translate-y-0.5 hover:z-10 group">
                        <i
                            class="ph-fill ph-palette text-4xl text-gray-600 group-hover:text-primary mb-2 transition"></i>
                        <span class="text-[12px] md:text-[13px] text-gray-700 text-center leading-tight">Alat
                            Lukis</span>
                    </a>
                    ...
                    <a href="#"
                        class="flex flex-col items-center justify-center p-4 border-r border-b border-gray-100 bg-white hover:shadow-lg transition relative hover:-translate-y-0.5 hover:z-10 group">
                        <i
                            class="ph-fill ph-book-open text-4xl text-gray-600 group-hover:text-primary mb-2 transition"></i>
                        <span class="text-[12px] md:text-[13px] text-gray-700 text-center leading-tight">Buku
                            Pelajaran</span>
                    </a>
                    <!-- Cat 11 -->
                    <a href="#"
                        class="flex flex-col items-center justify-center p-4 border-r border-b border-gray-100 bg-white hover:shadow-lg transition relative hover:-translate-y-0.5 hover:z-10 group">
                        <i
                            class="ph-fill ph-baseball-cap text-4xl text-gray-600 group-hover:text-primary mb-2 transition"></i>
                        <span class="text-[12px] md:text-[13px] text-gray-700 text-center leading-tight">Topi &
                            Dasi</span>
                    </a>
                    <!-- Cat 12 -->
                    <a href="#"
                        class="flex flex-col items-center justify-center p-4 border-r border-b border-gray-100 bg-white hover:shadow-lg transition relative hover:-translate-y-0.5 hover:z-10 group">
                        <i
                            class="ph-fill ph-basketball text-4xl text-gray-600 group-hover:text-primary mb-2 transition"></i>
                    ...
                    <a href="#"
                        ...
                        <span class="text-[12px] md:text-[13px] text-gray-700 text-center leading-tight">Kaos
                            Kaki</span>
                    </a>
                    <!-- Cat 14 -->
                    <a href="#"
                        class="flex flex-col items-center justify-center p-4 border-r border-b border-gray-100 bg-white hover:shadow-lg transition relative hover:-translate-y-0.5 hover:z-10 group">
                        <i
                            class="ph-fill ph-chalkboard text-4xl text-gray-600 group-hover:text-primary mb-2 transition"></i>
                        <span
                            class="text-[12px] md:text-[13px] text-gray-700 text-center leading-tight">Perlengkapan</span>
                    </a>
                    <!-- Cat 15 -->
                    <a href="#"
                        class="flex flex-col items-center justify-center p-4 border-r border-b border-gray-100 bg-white hover:shadow-lg transition relative hover:-translate-y-0.5 hover:z-10 group">
                        <i
                            class="ph-fill ph-laptop text-4xl text-gray-600 group-hover:text-primary mb-2 transition"></i>
                        <span class="text-[12px] md:text-[13px] text-gray-700 text-center leading-tight">Aksesoris
                            IT</span>
                    </a>
                    <!-- Cat 16 -->
                    <a href="#"
                        class="flex flex-col items-center justify-center p-4 border-r border-b border-gray-100 bg-white hover:shadow-lg transition relative hover:-translate-y-0.5 hover:z-10 group">
                        <i
                            class="ph-fill ph-dots-three-circle text-4xl text-gray-600 group-hover:text-primary mb-2 transition"></i>
        ...
        <div class="container mx-auto px-4 relative z-10 pt-8 pb-16">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-2">
                ...
                <!-- Product 1 -->
                <a href="#"
                    class="bg-white rounded-sm border border-gray-200 hover:border-primary hover:shadow-md transition flex flex-col group relative overflow-hidden">
                    <div
                        class="w-full aspect-square bg-gray-100 relative flex items-center justify-center text-gray-300">
                        <img src="https://picsum.photos/seed/seragam/300/300" alt="Product"
                        ...
                        <!-- Top right badge -->
                        <div
                            class="absolute top-0 right-0 bg-red-500 text-white text-[10px] font-bold px-1.5 py-1 z-10 shadow-sm rounded-bl-sm">
                            -15%
                        </div>
                    </div>
                    <div class="p-2.5 flex flex-col flex-1">
                        <h3
                            class="text-[13px] text-gray-800 line-clamp-2 leading-tight min-h-[38px] group-hover:text-primary transition">
                            <span
                                class="bg-primary text-white text-[9px] font-bold px-1 py-0.5 rounded-sm mr-1 align-middle">Star+</span>
                ...
                <a href="#"
                    ...
                    <div
                        class="w-full aspect-square bg-gray-100 relative flex items-center justify-center text-gray-300">
                        <img src="https://picsum.photos/seed/buku/300/300" alt="Product"
                            class="w-full h-full object-cover">
                    </div>
                    <div class="p-2.5 flex flex-col flex-1">
                        <h3
                ...
                <a href="#"
                    ...
                    <div
                        class="w-full aspect-square bg-gray-100 relative flex items-center justify-center text-gray-300">
                        <img src="https://picsum.photos/seed/sepatu/300/300" alt="Product"
                            class="w-full h-full object-cover">
                        <!-- Top left badge -->
                        <div
                            class="absolute top-0 left-0 bg-accent text-gray-900 text-[9px] font-bold px-1.5 py-0.5 z-10 flex flex-col items-center uppercase shadow-sm">
                ...
                <a href="#"
                    ...
                    <div
                        class="w-full aspect-square bg-gray-100 relative flex items-center justify-center text-gray-300">
                        <img src="https://picsum.photos/seed/tas/300/300" alt="Product"
                            class="w-full h-full object-cover">
                        <!-- Top right badge -->
                        <div
                            class="absolute top-0 right-0 bg-red-500 text-white text-[10px] font-bold px-1.5 py-1 z-10 shadow-sm rounded-bl-sm">
                ...
                <a href="#"
                    ...
                    <div
                        class="w-full aspect-square bg-gray-100 relative flex items-center justify-center text-gray-300">
                        <img src="https://picsum.photos/seed/pensil/300/300" alt="Product"
                            class="w-full h-full object-cover">
                    </div>
                    <div class="p-2.5 flex flex-col flex-1">
                        <h3
                ...
                <a href="#"
                    ...
                    <div
                        class="w-full aspect-square bg-gray-100 relative flex items-center justify-center text-gray-300">
                        <img src="https://picsum.photos/seed/topi/300/300" alt="Product"
                            class="w-full h-full object-cover">
                    </div>
                    <div class="p-2.5 flex flex-col flex-1">
                        <h3
                ...
                <a href="#"
                    ...
                    <div
                        class="w-full aspect-square bg-gray-100 relative flex items-center justify-center text-gray-300">
                        <img src="https://picsum.photos/seed/smp/300/300" alt="Product"
                            class="w-full h-full object-cover">
                        <!-- Top right badge -->
                        <div
                            class="absolute top-0 right-0 bg-red-500 text-white text-[10px] font-bold px-1.5 py-1 z-10 shadow-sm rounded-bl-sm">
                ...
                <a href="#"
                    ...
                    <div
                        class="w-full aspect-square bg-gray-100 relative flex items-center justify-center text-gray-300">
                        <img src="https://picsum.photos/seed/penggaris/300/300" alt="Product"
                            class="w-full h-full object-cover">
                    </div>
                    <div class="p-2.5 flex flex-col flex-1">
                        <h3
                ...
                <a href="#"
                    ...
                    <div
                        class="w-full aspect-square bg-gray-100 relative flex items-center justify-center text-gray-300">
                        <img src="https://picsum.photos/seed/bukugambar/300/300" alt="Product"
                            class="w-full h-full object-cover">
                        <!-- Top left badge -->
                        <div
                            class="absolute top-0 left-0 bg-accent text-gray-900 text-[9px] font-bold px-1.5 py-0.5 z-10 flex flex-col items-center uppercase shadow-sm">
                ...
                <a href="#"
                    ...
                    <div
                        class="w-full aspect-square bg-gray-100 relative flex items-center justify-center text-gray-300">
                        <img src="https://picsum.photos/seed/kaoskaki/300/300" alt="Product"
                            class="w-full h-full object-cover">
                    </div>
                    <div class="p-2.5 flex flex-col flex-1">
                        <h3
                ...
                <a href="#"
                    ...
                    <div
                        class="w-full aspect-square bg-gray-100 relative flex items-center justify-center text-gray-300">
                        <img src="https://picsum.photos/seed/ikatpinggang/300/300" alt="Product"
                            class="w-full h-full object-cover">
                    </div>
                    <div class="p-2.5 flex flex-col flex-1">
                        <h3
                ...
                <a href="#"
                    ...
                    <div
                        class="w-full aspect-square bg-gray-100 relative flex items-center justify-center text-gray-300">
                        <img src="https://picsum.photos/seed/pena/300/300" alt="Product"
                            class="w-full h-full object-cover">
                        <!-- Top right badge -->
                        <div
                            class="absolute top-0 right-0 bg-red-500 text-white text-[10px] font-bold px-1.5 py-1 z-10 shadow-sm rounded-bl-sm">
            ...
            <div class="flex justify-center mt-8">
                <button
                    class="bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 px-12 py-2 rounded-sm shadow-sm transition font-medium">Muat
                    Lebih Banyak</button>
            </div>
        </div>
            ...
            <div class="bg-white rounded-sm shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div
                    ...
                    <div class="flex items-start gap-2">
                        ...
                        <p><strong>Pusat E-Commerce Sekolah</strong><br>Jl. Pendidikan No. 123, Sudirman, Daerah Khusus
                            Ibukota Jakarta 10110</p>
                    </div>
    ...
    <footer class="bg-[#f5f5f5] border-t-4 border-primary pt-12 pb-8 mt-auto text-gray-600 text-[13px]">
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-10">
                ...
                <div class="lg:col-span-2">
                    ...
                    <div class="flex flex-wrap gap-2 mb-8">
                        <div
                            class="w-14 h-8 bg-white border border-gray-200 rounded shadow-sm flex items-center justify-center text-[10px] font-bold text-blue-800 hover:shadow-md transition">
                            BCA</div>
                        <div
                            class="w-14 h-8 bg-white border border-gray-200 rounded shadow-sm flex items-center justify-center text-[10px] font-bold text-blue-600 hover:shadow-md transition">
                            MANDIRI</div>
                        <div
                            class="w-14 h-8 bg-white border border-gray-200 rounded shadow-sm flex items-center justify-center text-[10px] font-bold text-orange-500 hover:shadow-md transition">
                            BNI</div>
                        <div
                            class="w-14 h-8 bg-white border border-gray-200 rounded shadow-sm flex items-center justify-center text-[10px] font-bold text-blue-900 hover:shadow-md transition">
                            BRI</div>
                        <div
                            class="w-14 h-8 bg-white border border-gray-200 rounded shadow-sm flex items-center justify-center text-[10px] font-bold text-green-500 hover:shadow-md transition">
                            GOPAY</div>
                        <div
                            class="w-14 h-8 bg-white border border-gray-200 rounded shadow-sm flex items-center justify-center text-[10px] font-bold text-purple-600 hover:shadow-md transition">
                            OVO</div>
                        <div
                            class="w-14 h-8 bg-white border border-gray-200 rounded shadow-sm flex items-center justify-center text-[10px] font-bold text-blue-400 hover:shadow-md transition">
                            DANA</div>
                    </div>
                    ...
                    <div class="flex flex-wrap gap-2">
                        <div
                            class="w-14 h-8 bg-white border border-gray-200 rounded shadow-sm flex items-center justify-center text-[10px] font-bold text-red-600 hover:shadow-md transition">
                            JNE</div>
                        <div
                            class="w-14 h-8 bg-white border border-gray-200 rounded shadow-sm flex items-center justify-center text-[10px] font-bold text-red-500 hover:shadow-md transition">
                            J&T</div>
                        <div
                            class="w-14 h-8 bg-white border border-gray-200 rounded shadow-sm flex items-center justify-center text-[10px] font-bold text-blue-500 hover:shadow-md transition">
                            TIKI</div>
                        <div
                            class="w-14 h-8 bg-white border border-gray-200 rounded shadow-sm flex items-center justify-center text-[10px] font-bold text-red-700 hover:shadow-md transition">
                            SICEPAT</div>
                        <div
                            class="w-14 h-8 bg-white border border-gray-200 rounded shadow-sm flex items-center justify-center text-[10px] font-bold text-green-600 hover:shadow-md transition">
                            GOSEND</div>
                    </div>
                </div>
                ...
                <div class="lg:col-span-1">
                    ...
                    <ul class="space-y-4 mb-8">
                        <li><a href="#" class="flex items-center gap-3 hover:text-primary transition"><i
                                    class="ph-fill ph-facebook-logo text-xl text-blue-600"></i> Facebook</a></li>
                        <li><a href="#" class="flex items-center gap-3 hover:text-primary transition"><i
                                    class="ph-fill ph-instagram-logo text-xl text-pink-600"></i> Instagram</a></li>
                        <li><a href="#" class="flex items-center gap-3 hover:text-primary transition"><i
                                    class="ph-fill ph-twitter-logo text-xl text-blue-400"></i> Twitter</a></li>
                    </ul>

                    <h4 class="font-bold text-gray-800 mb-4 uppercase text-xs tracking-wider">Download App E-Sekolah
                    </h4>
                    <div class="flex flex-col gap-2">
                        <a href="#"
                            class="w-32 h-10 bg-gray-800 text-white rounded flex items-center justify-center gap-2 hover:bg-gray-700 transition">
            ...
            <div
                class="border-t border-gray-300 pt-6 flex flex-col md:flex-row items-center justify-between text-xs text-gray-500">
