    ...
    <div class="flex flex-col gap-6">
        ...
        <div class="bg-white p-5 rounded-xl shadow-sm border border-gray-200 flex flex-col">
            ...
            <div class="flex flex-col md:flex-row items-start md:items-center gap-4 w-full">
                <div class="flex items-start gap-4 md:w-1/2">
                    ...
                    <img src="https://picsum.photos/seed/seragam/150/150" alt="Produk" class="w-20 h-20 rounded-lg object-cover border border-gray-100 shrink-0">
                    <div class="flex flex-col">
                        <h3 class="text-sm font-medium text-gray-800 line-clamp-2 hover:text-primary cursor-pointer transition">Seragam SD Merah Putih Lengan Pendek Berkualitas</h3>
                        <span class="text-xs text-gray-500 mt-1">Variasi: Ukuran M</span>
                    </div>
                </div>
                
                <div class="flex flex-col md:flex-row items-center justify-between w-full md:w-1/2 gap-4 md:gap-0 mt-4 md:mt-0">
                    <div class="text-gray-700 font-medium md:w-1/3 text-center">Rp55.000</div>
                    ...
                    <div class="flex items-center justify-center md:w-1/3">
                        <div class="flex items-center border border-gray-300 bg-white overflow-hidden h-8 rounded-sm">
                            <button class="w-8 h-full flex items-center justify-center text-gray-500 hover:bg-gray-100 transition border-r border-gray-300"><i class="ph-bold ph-minus text-xs"></i></button>
                            <input type="text" value="1" class="w-10 h-full text-center outline-none text-gray-800 text-sm font-medium">
                            <button class="w-8 h-full flex items-center justify-center text-gray-500 hover:bg-gray-100 transition border-l border-gray-300"><i class="ph-bold ph-plus text-xs"></i></button>
                        </div>
                    </div>

                    <div class="text-primary font-bold md:w-1/3 text-center">Rp55.000</div>
                    
                    <button class="text-gray-500 hover:text-red-500 transition md:w-16 text-center text-sm">
                        Hapus
                    </button>
                </div>
            </div>
            
            <div class="mt-4 pt-4 border-t border-dashed border-gray-200 flex items-center gap-2 text-sm text-gray-600">
                <i class="ph-bold ph-ticket text-primary"></i> Tambahkan kode Voucher Toko
            </div>
        </div>
        ...
        <div class="bg-white p-5 rounded-xl shadow-sm border border-gray-200 flex flex-col">
            ...
            <div class="flex flex-col md:flex-row items-start md:items-center gap-4 w-full">
                <div class="flex items-start gap-4 md:w-1/2">
                    <input type="checkbox" class="w-5 h-5 border-2 border-gray-300 rounded cursor-pointer mt-8 md:mt-0 text-primary" checked>
                    <img src="https://picsum.photos/seed/desain/150/150" alt="Produk" class="w-20 h-20 rounded-lg object-cover border border-gray-100 shrink-0">
                    <div class="flex flex-col">
                        <h3 class="text-sm font-medium text-gray-800 line-clamp-2 hover:text-primary cursor-pointer transition">Jasa Pembuatan Logo Bisnis & E-Sports Profesional</h3>
                    </div>
                </div>
                
                <div class="flex flex-col md:flex-row items-center justify-between w-full md:w-1/2 gap-4 md:gap-0 mt-4 md:mt-0">
                    <div class="text-gray-700 font-medium md:w-1/3 text-center">Rp150.000</div>
                    ...
                    <div class="text-primary font-bold md:w-1/3 text-center">Rp150.000</div>
        ...
        <div class="px-4 md:px-6">
            ...
            <div class="flex flex-col md:flex-row items-center justify-between py-4 gap-4">
                ...
                <div class="flex items-center gap-6 w-full md:w-auto text-sm text-gray-700">
                    ...
                    <button class="hover:text-red-500 transition">Hapus</button>
                    <button class="hover:text-primary transition hidden md:block">Tambahkan ke Favorit</button>
                </div>
