                ...
                <a href="{{ url('/product/' . $product->id) }}"
                    ...
                    <div class="p-2.5 flex flex-col flex-1">
                        ...
                        <div class="mt-2 flex flex-col justify-end mt-auto gap-1">
                            <span
                                class="text-primary font-bold text-sm md:text-base">Rp{{ number_format($product->price, 0, ',', '.') }}</span>
                            <div class="flex items-center justify-between">
                                ...
                                <span
                                    class="text-[11px] text-gray-500">{{ $product->sales_count >= 10000 ? floor($product->sales_count / 1000) . 'RB+' : $product->sales_count }}
                                    terjual</span>
                            </div>
                        </div>
                    </div>
